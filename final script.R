...
orig_database$Nationality[grep("fr[a|e]n[c|?]", tolower(orig_database$Nationality))] <- "France"
...
orig_database$Residence[grep("fr[a|e]n[c|?]", tolower(orig_database$Residence))] <- "France"
...
colmumbers_clean <- data.frame(colnames(clean_database))
